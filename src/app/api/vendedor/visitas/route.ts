// src/app/api/vendedor/visitas/route.ts
// API para crear y listar visitas del vendedor
...
/**
 * POST /api/vendedor/visitas
 * Crea una nueva visita sincronizada desde la app móvil
 */
export async function POST(request: NextRequest) {
  try {
    ...
    const visitaData = {
      ...visita,
      // Convertir arrays de IDs a referencias si es necesario
    ...
    // También registrar en el historial del cliente
...
/**
 * GET /api/vendedor/visitas?vendedorId=xxx&organizationId=xxx
 * Lista visitas del vendedor
 */
