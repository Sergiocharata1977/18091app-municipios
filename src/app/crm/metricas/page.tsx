    ...
    const loadData = async () => {
      ...
      try {
        ...
        const params = new URLSearchParams({
          ...
          limit: '1000', // Traer volumen suficiente para métricas
          // fecha_desde: desde.toISOString() // Idealmente filtrar en API, por ahora traemos recientes
        });
        ...
        if (data.acciones) {
          ...
          const filtered = (data.acciones as CRMAccion[]).filter(
