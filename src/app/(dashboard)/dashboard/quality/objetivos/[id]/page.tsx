    ...
    <div className="space-y-6 p-6">
      ...
      <Card>
        <CardHeader className="flex flex-row items-center justify-between">
          ...
          {editingSection !== 'responsables' && (
            <Button
              variant="ghost"
              size="sm"
              onClick={() => startEditing('responsables')}
              className="gap-2"
            >
              <Edit className="h-4 w-4" />
              Editar
          ...
          {editingSection === 'responsables' ? (
            <div className="space-y-4">
              <div>
                ...
                <select
                  value={editValues.responsible_user_id || ''}
                  onChange={e =>
                    setEditValues({
                      ...editValues,
      ...
      <Card>
        <CardHeader className="flex flex-row items-center justify-between">
          ...
          <Button
            ...
            onClick={() =>
              window.open(
                `/dashboard/quality/indicadores?objective_id=${objectiveId}`,
                '_blank'
              )
            }
            className="gap-2"
                  ...
                  <CardContent className="p-4">
                    <div className="flex justify-between items-start">
                      ...
                      <div className="flex gap-2">
                        ...
                        <Button variant="outline" size="sm" asChild>
                          <Link
                            href={`/dashboard/quality/mediciones?indicator_id=${indicator.id}`}
                          >
