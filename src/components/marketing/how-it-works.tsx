...
const icons = [FileText, Map, Sparkles, FileText, Map, Sparkles]; // Map to the new icons or use translation keys
          ...
          {t.howItWorks.features.slice(0, 3).map((feature, index) => {
            ...
            return (
              <div key={index} className="relative group h-full">
                <div className="bg-white border border-slate-200 rounded-2xl p-8 h-full transition-all duration-300 hover:shadow-xl hover:shadow-primary/5 hover:border-primary/20">
