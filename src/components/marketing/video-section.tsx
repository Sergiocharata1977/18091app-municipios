      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-slate-900 mb-4">
            Conoce a Don Cándido IA en Acción
          </h2>
          <p className="text-lg text-slate-600 max-w-2xl mx-auto">
            Descubre cómo nuestra inteligencia artificial está transformando la
            certificación ISO 9001 para PyMEs como la tuya.
          </p>
        </div>
          ...
          {!isPlaying ? (
            ...
            >
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="w-20 h-20 rounded-full bg-white/90 backdrop-blur-sm flex items-center justify-center shadow-2xl transition-all duration-300 group-hover:scale-110 group-hover:bg-emerald-600 group-hover:text-white text-emerald-600">
                  <svg
