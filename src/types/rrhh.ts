...
export interface Department {
  ...
  responsable_id?: string; // Personnel ID (opcional)
  is_active: boolean;
  organization_id: string;
  created_at: Date;
  updated_at: Date;
...
export interface Position {
  ...
  // Asignaciones de contexto (arrays opcionales)
...
export interface Personnel {
  ...
  // Información organizacional (TEXTO LIBRE - Simplificado)
  puesto?: string; // ✅ MODIFICADO: Texto libre en lugar de puestoId
  departamento?: string; // ✅ MODIFICADO: Texto libre en lugar de departamentoId
